package com.miteno.com.security;

import com.miteno.com.domain.PersistentToken;
 ...
 * Best Practice</a></li>
 * <li><a href="https://github.com/blog/1661-modeling-your-app-s-user-session">Github's "Modeling your App's Account Session"</a></li>
 * </ul>
 * <p>
...
public class PersistentTokenRememberMeServices extends
    ...
    protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request,
        ...
        token.setUserAgent(request.getHeader("Account-Agent"));
        try {
    ...
    protected void onLoginSuccess(HttpServletRequest request, HttpServletResponse response, Authentication
        ...
        PersistentToken token = userRepository.findOneByLogin(login).map(u -> {
            ...
            t.setUserAgent(request.getHeader("Account-Agent"));
            return t;
        }).orElseThrow(() -> new UsernameNotFoundException("Account " + login + " was not found in the database"));
        try {
            persistentTokenRepository.saveAndFlush(token);
            addCookie(token, request, response);
        } catch (DataAccessException e) {
